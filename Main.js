...
form.addEventListener('submit', function(event) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbxwl_htCgBt9jGOYeAhR1JWLJ9-OePROYzENGtKRjOV/dev', { // Replace with your web app URL
        method: 'POST',
        headers: {
    ...
    .catch((error) => {
        ...
        alert('Error submitting data.'); // Notify the user of an error
    });
});